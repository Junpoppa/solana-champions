<#
Singleton launcher for the Unity AI relay MCP server (unity-mcp).
...
shows up as unity-mcp "randomly disconnecting" / "connection revoked". First session wins;
later sessions get a clear error here instead of silently killing the first one.
